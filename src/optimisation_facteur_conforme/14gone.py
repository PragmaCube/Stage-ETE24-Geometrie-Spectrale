...
chemin = "C:/Users/pragm/OneDrive/Bureau/Stage/FreeFEM++/optimisation_facteur_conforme/"
...
sauvegarde = "C:/Users/pragm/OneDrive/Bureau/Stage/FreeFEM++/"

point = {"tau1" : 0, "tau2" : 0, "sigma1" : 0, "sigma2" : 0, "valeurPropre" : 0}
...
def valeurPropre(params):
    ...
    print(float(texte.split("normalisation : ")[-1].split("\n")[0]))
